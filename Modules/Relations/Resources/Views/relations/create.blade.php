...
{!! Form::open([
    ...
    {!! Form::submit('Get relation info', ['class' => 'btn btn-primary relationvat']) !!}
...
{!! Form::submit('Create New Relation', ['class' => 'btn btn-primary']) !!}
